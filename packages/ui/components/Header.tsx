...
const Minifyoptions = (props: Props): JSX.Element => {
  ...
  return (
    <div className="flex flex-row justify-center items-center md:space-x-10 mob_only:space-y-10 mob_only:flex-wrap mob_only:pt-8">
      {ActivateBtn && (
        <input
      ...
      <div className=" flex flex-row justify-evenly md:items-center items-start md:space-x-10 mob_only:w-full">
        <label
          htmlFor="modal"
        ...
        >
          ...
          <p
            className={` whitespace-nowrap text-sm sm:text-base ${
              ActivateBtn ? "text-white" : "text-gray-300"
            }`}
          >
            Add Password
          </p>
