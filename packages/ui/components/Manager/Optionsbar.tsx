...
const Optionsbar = () => {
    return (
      <div className="optionsbar min-w-fit capitalize text-blue-600 text-lg p-2 ">
        <div className="hover:bg-blue-50 rounded-lg flex flex-row justify-start items-center space-x-2 cursor-pointer py-5 px-4 my-1">
          <div className="icon">
            <svg
              stroke="currentColor"
              fill="currentColor"
